...
export default function Hero({ query, onQueryChange, activeCategories, onCategoryToggle, queryIsQuestion, onAskQuestion, askLoading, isSearching }) {
    ...
    <section className="pt-10 pb-8 md:pt-14 md:pb-12" style={{ background: '#FAFAF8' }}>
      <div className="max-w-3xl mx-auto px-6 md:px-8 text-center">
        ...
        <div className="relative max-w-2xl mx-auto mb-3">
          ...
          >
            <div className="pl-5 pr-3 flex-shrink-0" style={{ color: '#b0b0aa' }}>
            ...
            <input
              ...
              placeholder="Search by keyword, topic, or framework — or ask a strategic question"
